  ...
  return (
    <div className=" mx-auto flex-col py-2 border-2 border-[#e5e5e5]">
      ...
      <div className="space-y-4  mt-4 mr-12">
        <div className="w-[270px] h-[403px] p-4 space-y-3 bg-[#C4C4C4] mt-4 rounded-lg">
          <p className="font-inter font-light text-white">Bacola Natural Foods</p>
          <h3 className=" text-xl font-inter font-light text-[#202435]">Special Organic</h3>
          <h3 className=" text-2xl font-semibold text-[#202435] mb-2">Roats Burger</h3>
          <p className="text-sm font-light text-[#202435]">only-from</p>
          <span className="text-3xl  font-dosis font-bold text-[#D51243]">$14.99</span>
        </div>
      </div>
