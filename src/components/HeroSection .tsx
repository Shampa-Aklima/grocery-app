  ...
  return (
    <div>
      <div className="w-[870px] h-[484px] bg-[#C4C4C4]  p-8 rounded-lg mb-8 ">
        <div className="px-5">
          <span className="inline-block text-sm mb-2 mt-8">Exclusive Offer</span>
          ...
          <p className="font-inter">from<span className="font-dosis text-3xl text-[#D51243] font-bold">$7.99</span></p>
          <Button className="variant=ghost mt-3 bg-[#35AFA0] border-1">Shop Now</Button>
        </div>
      </div>
    </div>
  );
